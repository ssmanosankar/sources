...
$.each(data,function(key,value){
    attend_data += '<tr>';
    attend_data += '<td>'+'<input type="text" class="form-control"  id="name" value='+value.name+' name="name1" disabled></td>';
    attend_data += '<td>'+'<input type="text" class="form-control"  id="date" name="date" value="" disabled>'+'</td>';
    attend_data += '<td>'+'<input list="text" class="form-control"  name="status" id="status">'+
    '<datalist id="status">'+
